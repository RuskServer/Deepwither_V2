...
@Component
public class AF03ConductorHelmet implements CustomItem {

    private final Map<StatType, Double> baseStats;

    public AF03ConductorHelmet() {
        this.baseStats = new EnumMap<>(StatType.class);
        this.baseStats.put(StatType.DEFENSE, 7.0);
        this.baseStats.put(StatType.MAGIC_DEFENSE, 7.0);
    ...
    public String getDisplayName() {
        return "§f§lAF-03H \"Conductor Visor\"";
    }
