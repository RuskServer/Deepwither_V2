...
@Component
public class AF03ConductorChestplate implements CustomItem {

    private final Map<StatType, Double> baseStats;

    public AF03ConductorChestplate() {
    ...
    @Override
    public String getId() {
        return "af03_conductor_chestplate";
    }
    ...
    public String getDisplayName() {
        return "§f§lAF-03C \"Conductor Frame\"";
    }
