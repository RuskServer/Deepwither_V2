...
@Component
public class AfStaticSpreadCaster implements WandItem {

    private final Map<StatType, Double> baseStats;

    public AfStaticSpreadCaster() {
        ...
        this.baseStats.put(StatType.LIGHTNING_DAMAGE, 8.0);
    }

    @Override
    public String getId() {
        return "af_static_spread_caster";
    }
    ...
    public String getDisplayName() {
        return "§a§lAF-MW12「スタティック・スプレッド・キャスター」";
    }
    ...
    public String getFlavorText() {
        return "Aetherline Foundryが中級術者向けに量産した範囲制圧用魔導杖。複雑な術式強化機構を排し、魔力を“広く・均等に”拡散させる設計が採用されている。単体火力や爆発的出力には向かないが、集団戦や探索中の雑魚処理では非常に高い安定性を発揮する。";
    }
